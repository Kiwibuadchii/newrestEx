...
const promotion = require('../../models/BookStore/promotion/promo');
...
router.get('/:id', async (req, res) => {
    try {
        ...
        const product = await promotion.findById(req.params.id);
...
router.put('/:id', async (req, res) => {
    try {
        ...
        const data = await promotion.updateOne(req.params,req.body)
...
router.delete('/:id', async (req, res) => {
    try {
        const data = await promotion.findByIdAndDelete({_id: req.params.id});

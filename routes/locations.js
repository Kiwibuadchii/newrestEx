...
router.get('/:id', async (req, res) => {
    try {
        ...
        const product = await location.findById(req.params.id);
...
router.put('/:id', async (req, res) => {
    try {
        ...
        const data = await location.updateOne(req.params,req.body)
...
router.delete('/:id', async (req, res) => {
    try {
        const data = await location.findByIdAndDelete({_id: req.params.id});
